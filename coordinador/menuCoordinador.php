...
<head>
    ...
    <link rel="stylesheet" href="menuCoordinador.css">
    <!-- Font Awesome v6 -->
    ...
    <div class="d-flex">
        <div id="sidebar">
            ...
            <a href="#" data-bs-toggle="collapse" data-bs-target="#menuPerfil">
                <i class="fas fa-user-graduate me-2"></i> Coordinador
            </a>
            <div class="collapse" id="menuPerfil">
                <a href="#" onclick="loadPage('perfilCoordinador.php')" class="ps-3">
            ...
            <div class="collapse" id="menuReportes">
                <a href="#" onclick="loadPage('../administrador/reporteArchivos.php')" class="ps-3">
