        ...
        <div class="container-fluid">
            ...
            <div class="dropdown">
                <a class="d-flex align-items-center text-white text-decoration-none dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    ...
                    Bienvenido, <?php echo isset($_SESSION['nombreUsuario']) ? $_SESSION['nombreUsuario'] : 'Usuario'; ?>
                </a>
    ...
    <div class="d-flex">
        <div id="sidebar">
            ...
            <a href="#" data-bs-toggle="collapse" data-bs-target="#menuPerfil">
                <i class="fas fa-user-graduate me-2"></i> Usuario
            </a>
            <div class="collapse" id="menuPerfil">
                <a href="#" onclick="loadPage('perfilUsuario.php')" class="ps-3">
                    <i class="fas fa-id-badge me-2"></i> Editar Perfil
                </a>
            </div>
            ...
            <div class="collapse" id="menuArchivos">
                ...
                <a href="#" onclick="loadPage('inicio.php')" class="ps-3">
                    <i class="fas fa-file-alt me-2"></i> Subir  Archivos
                </a>
            </div>
            ...
            <!-- Opción Acerca De -->
            <a href="#" onclick="loadPage('acerca.html')">
                <i class="fas fa-info-circle me-2"></i> Acerca De
            </a>
        </div>
        <div id="content">
            <iframe id="iframe" src="CambiarContrasena.php"></iframe>
        </div>
    </div>
    <script>
